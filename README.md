...
Python Library that wraps incremental driver models to make it easier to generate simple and complex load cases and facilitates the post-processing of the data.

## Goal
The following are the goals for this repo:
1) Make working with incremental driver faster and easier
2) Integrate the analysis of incremental driver with the soil models developed/being developed by this organization
